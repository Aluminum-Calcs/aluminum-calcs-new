    ...
    return <section className="desktop_quotation">
      <div className="container">
        <div className="preview">
          <div className="card-heading section-header">
              <div className="card-icon"><i className="fa fa-sticky-note" aria-hidden="true" /></div>
              <div>
                <p className="eyebrow">Detailed totals</p>
                <h2>Quotation Preview</h2>
              </div>
          </div>
          <div className="preview_content card-content">
            {sectionsHTML}
          </div>
        </div>
